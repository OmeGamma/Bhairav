    ...
    <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-6 animate-fade-in-up">
      ...
      <div className="relative">
        ...
        <input
          ...
          className="w-full pl-10 pr-3 py-2.5 glass-sm border border-[var(--color-bhairav-border-strong)] rounded-md text-sm text-[var(--color-bhairav-text)] focus:outline-none focus:border-[var(--color-bhairav-primary)]"
        />
      </div>
                ...
                <div className="flex items-start justify-between gap-4">
                  <div className="min-w-0 flex-1">
                    <div className="flex items-center gap-2 mb-1 flex-wrap">
                     ...
                     <h3 className="text-base font-semibold text-[var(--color-bhairav-text)] mt-1">{task.title}</h3>
