          ...
          return (
            <NavLink
              ...
              className={cn(
                ...
                isActive
                  ? "bg-[var(--color-bhairav-primary)]/15 text-[var(--color-bhairav-primary)] shadow-[0_0_15px_rgba(59,130,246,0.1)] border-l-[3px] border-[var(--color-bhairav-primary)]"
                  : "text-[var(--color-bhairav-text-muted)] hover:bg-[var(--color-bhairav-surface-hover)] hover:text-[var(--color-bhairav-text)] border-l-[3px] border-transparent"
              )}
            >
